                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" id="input-file-disable-remove" name="ps_img_category_default" class="dropify" data-default-file="{{asset('customAuth/'.$general->ps_img_category_default)}}" data-show-remove="false" />
                        </div>
                        <div class="form-group">
                            <label for="name">Default Image User</label>
                            <input type="file" id="input-file-disable-remove" name="ps_img_user_default" class="dropify" data-default-file="{{asset('customAuth/'.$general->ps_img_user_default)}}" data-show-remove="false" />
                        </div>
    </form>
</div>
</div>
