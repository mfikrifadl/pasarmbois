...
@section('content')
<div class="container-fluid" data-codepage="updateproduct" data-pagetitle="Edit Produk">
    <h3 class="mt-4">Edit Produk</h3>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="\dashboard\">Produk</a></li>
        <li class="breadcrumb-item"><a href="\dashboard\product">Daftar Produk</a></li>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" id="input-file-disable-remove" name="pp_link" class="dropify" data-show-remove="false" required>{{$product->pp_link}}</input>
                                </div>
                            </div>
                        </div>
                        <!-- end image gallery -->
