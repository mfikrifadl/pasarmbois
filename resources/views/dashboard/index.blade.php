                ...
                <div class="d-flex flex-row comment-row">
                    ...
                    <div class="comment-text w-100">
                        ...
                        <div class="comment-footer">
                            <span class="text-muted float-right">{{tgl_indo($cm->pc_created_at)}}</span>
    ...
    <div class="col-sm-12 col-lg-6">
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="listProductDash" class="table table-hover table-bordered data" style="width:100%">
                        <thead>
                            <tr>
