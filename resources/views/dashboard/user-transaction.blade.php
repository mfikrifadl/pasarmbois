...
<div class="container-fluid">
    ...
    <h1 class="mt-4">Transaksi User</h1>
    @else
    <h1 class="mt-4">Transaksi Tamu</h1>
    @endif
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="\dashboard\">Dashboard</a></li>
        @if(isset($transactions))
        <li class="breadcrumb-item active">Transaksi User</li>
        @else
        <li class="breadcrumb-item active">Transaksi Tamu</li>
        @endif
    </ol>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <div id="listTransaction_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                    <div class="row">
                        <div class="col-12">
                            <table id="dataTable" class="table table-hover table-bordered dataTable no-footer dtr-inline" style="width: 100%;" role="grid" aria-describedby="listTransaction_info">
                                <thead>
                                    <tr role="row">
                                        <th></th>
